(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("list", ["vue"], factory);
	else if(typeof exports === 'object')
		exports["list"] = factory(require("vue"));
	else
		root["list"] = factory(root["Vue"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_204__) {
...
/***/ (function(module, exports) {
	...
	exports.axiosOptions = axiosOptions;
	// 通过配置中的method配置项，判断数据是放入params中还是data中。
	// 供axios使用
	function axiosOptions(method, data) {
	    var options = {
	        method: method || 'get'
	    };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-01537689&scoped=true!../../../node_modules/sass-loader/lib/loader.js!./list.scss", function() {
				var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-01537689&scoped=true!../../../node_modules/sass-loader/lib/loader.js!./list.scss");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".mbSpace[_v-01537689] {\n  margin-bottom: 20px; }\n\n.searchBtnArea[_v-01537689] {\n  width: 90px;\n  margin-left: 20px; }\n\n.el-button.searchBtn[_v-01537689] {\n  height: 40px;\n  margin: 0;\n  margin-left: 0; }\n\n.el-button.mgb10[_v-01537689] {\n  margin-bottom: 10px;\n  margin-left: 0; }\n", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _actionObject = __webpack_require__(209);
	...
	exports.default = {
	  ...
	  created: function created() {
	    ...
	    // 初始化搜索内容
	    this.$data.normalQueryValue = JSON.parse((0, _stringify2.default)(this.value.query));
	    this.$data.advQueryValue = JSON.parse((0, _stringify2.default)(this.value.query));
	  },
	  ...
	  computed: {
	    // 搜索栏 是否显示
	    seachBarVisible: function seachBarVisible() {
	      return this.config.query && this.config.query.normal;
	    },

	    // 高级搜索 是否显示
	    advSearchBarVisible: function advSearchBarVisible() {
	      return this.config.query && this.config.query.normal && this.config.query.adv;
	    },
	    batchActionsVisible: function batchActionsVisible() {
	      return this.config.list.selectAll && this.config.toolbar && this.config.toolbar.batchActions;
	    },
	    toolsVisible: function toolsVisible() {
	      return this.config.toolbar && this.config.toolbar.tools;
	    },
	    pagingVisible: function pagingVisible() {
	  ...
	  methods: {
	    ...
	    loadtableData: function loadtableData() {
	      ...
	      var dataSource = this.config.list.datasource;
	      ...
	      if (dataSource.paramFields.query) {
	        ...
	        postData = (0, _assign2.default)(postData, this.value.query);
	      }

	      this.$axios(dataSource.apiUrl, (0, _helper.axiosOptions)(dataSource.method, postData)).then(function (res) {
	        var listField = dataSource.resField.list;
	        var pageingTotalField = dataSource.resField.pageingTotal;
	        _this.$data.tableData = listField ? (0, _get3.default)(res.data, "" + listField) : res.data;
	        _this.$data.pageCount = pageingTotalField ? Math.ceil((0, _get3.default)(res.data, "" + pageingTotalField, 0) / _this.value.pageSize) : 1;
	      });
	    },
	    ...
	    eventHandlerConfirm: function eventHandlerConfirm(handler) {
	      var item = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

	      var _this2 = this;

	      var multipleSelection = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
	      var needConfirm = arguments[3];
	      ...
	      if (needConfirm) {
	        this.$confirm(needConfirm, "提示", {
	          ...
	          _this2.eventHandler(handler, item, multipleSelection);
	        }).catch(function (err) {});
	      }
	    },
	      ...
	      switch (type) {
	        case "ajax":
	          ...
	          options.params.forEach(function (item) {
	            params[item.name] = _ncformCommon.ncformUtils.smartAnalyze(item.value, {
	              data: handlerData
	            });
	          });

	          this.$axios(handler.options.apiUrl, (0, _helper.axiosOptions)(handler.options.method, params)).then(function (res) {
	          ...
	          break;
	        case "page":
	          var path = _ncformCommon.ncformUtils.smartAnalyze(options.route, {
	            data: handlerData
	          });
	        ...
	        case "modal":
	          var newValue = {};
	          for (var key in options.component.value) {
	            newValue[key] = _ncformCommon.ncformUtils.smartAnalyze(options.component.value[key], {
	              data: handlerData
	            });
	          }

	          this.$data.modal = (0, _assign2.default)({}, this.$data.modal, options.component);
	    ...
	    // 页码变化
	    currentChange: function currentChange(currentIndex) {
	    ...
	    search: function search() {
	      this.value.pageNum = 1;
	      this.value.query = (0, _assign2.default)({}, this.value.query, this.$data.normalQueryValue, this.$data.advQueryValue);
	      this.loadtableData();
	    }
	  },
	  watch: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-04ae831c/action-object.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-04ae831c&scoped=true!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./action-object.vue", function() {
				var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-04ae831c&scoped=true!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./action-object.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".action-object[_v-04ae831c] {\n  display: inline-block; }\n", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    dealComponentValue: function dealComponentValue() {
	      if (this.config.handler.type === "component") {
	        var values = this.config.handler.options.component.value;
	        for (var key in values) {
	          this.$data.componentValue[key] = _ncformCommon.ncformUtils.smartAnalyze(values[key], {
	            data: [{
	              symbol: "$item",
	              value: this.item
	            }, {
...
/***/ (function(module, exports) {
	...
	module.exports = "\n<div class=\"action-object\" _v-04ae831c=\"\">\n  <component v-if=\"config.handler.type === 'component'\" :is=\"config.handler.options.component.name.replace(/\\./g, '_')\" :config=\"config.handler.options.component.config\" :value=\"componentValue\" _v-04ae831c=\"\">\n  </component>\n  <slot v-else=\"\" _v-04ae831c=\"\"></slot>\n</div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".modal .el-dialog__body {\n  padding: 0 20px 15px; }\n", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  created: function created() {
	    ...
	    _eventHub2.default.$on("toModal_" + this.$data.modalId, function (config) {
	  ...
	  data: function data() {
	    return {
	      ...
	      modalId: "event_" + Math.random().toString(36).substring(2)
	    };
	  },

	  computed: {
	    mdConfig: function mdConfig() {
	      var mdConfig = JSON.parse((0, _stringify2.default)(this.modalConfig));
	      mdConfig.title = mdConfig.title || "Dialog";
	      mdConfig.buttons = mdConfig.buttons || {};
	      mdConfig.buttons.others = mdConfig.buttons.others || [];
	      mdConfig.buttons.confirm = (0, _assign2.default)({}, {
	        enable: true,
	        name: "确定",
	      ...
	      mdConfig.buttons.cancel = (0, _assign2.default)({}, {
	        enable: true,
	        name: "取消",
	  ...
	  methods: {
	    _modalButtonEvent: function _modalButtonEvent(config) {
	      _eventHub2.default.$emit("fromModal_" + this.$data.modalId, config);
	    },
	  ...
	  watch: {
	    visibleData: function visibleData(newVal) {
...
/***/ (function(module, exports) {
	...
	module.exports = "<div class=\"list\" _v-01537689=\"\">\n  <el-row type=\"flex\" align=\"bottom\" class=\"mbSpace\" v-if=\"seachBarVisible\" _v-01537689=\"\">\n    <el-col _v-01537689=\"\">\n      <!-- 普通搜索配置 -->\n      <ncform :form-schema=\"config.query.normal\" v-model=\"normalQueryValue\" form-name=\"normalQuery\" _v-01537689=\"\"></ncform>\n      <!-- 高级搜索配置 -->\n      <ncform v-if=\"advSearchBarVisible\" v-show=\"showAdvSearch\" :form-schema=\"config.query.adv\" v-model=\"advQueryValue\" form-name=\"advQuery\" _v-01537689=\"\"></ncform>\n    </el-col>\n    <div class=\"searchBtnArea\" _v-01537689=\"\">\n      <!-- 搜索按钮区域 -->\n      <el-button type=\"info\" class=\"searchBtn mgb10\" icon=\"el-icon-refresh\" @click=\"resetList()\" plain=\"\" _v-01537689=\"\">重置</el-button>\n      <el-button type=\"info\" v-if=\"advSearchBarVisible\" v-show=\"!showAdvSearch\" class=\"searchBtn mgb10\" icon=\"el-icon-plus\" @click=\"showAdvSearch = !showAdvSearch\" plain=\"\" _v-01537689=\"\">展开</el-button>\n      <el-button type=\"info\" v-if=\"advSearchBarVisible\" v-show=\"showAdvSearch\" class=\"searchBtn mgb10\" icon=\"el-icon-minus\" @click=\"showAdvSearch = !showAdvSearch\" plain=\"\" _v-01537689=\"\">收起</el-button>\n      <el-button type=\"primary\" class=\"searchBtn\" icon=\"el-icon-search\" plain=\"\" @click=\"search\" _v-01537689=\"\">搜索</el-button>\n    </div>\n  </el-row>\n\n  <el-row _v-01537689=\"\">\n    <el-col :span=\"24\" _v-01537689=\"\">\n      <el-row type=\"flex\" _v-01537689=\"\">\n        <template v-if=\"batchActionsVisible\">\n          <!-- 批量操作 按钮 -->\n          <action-object v-if=\"config.toolbar.batchActions.delete\" :config=\"config.toolbar.batchActions.delete\" :selected=\"multipleSelection\" _v-01537689=\"\">\n            <el-button v-if=\"config.toolbar.batchActions.delete.enable\" :disabled=\"this.$data.multipleSelection.length == 0\" type=\"danger\" icon=\"el-icon-delete\" @click=\"eventHandler(config.toolbar.batchActions.delete.handler, null, multipleSelection)\" plain=\"\" _v-01537689=\"\">\n              {{config.toolbar.batchActions.delete.name}}\n            </el-button>\n          </action-object>\n          <template v-if=\"config.toolbar.batchActions.others\">\n            <action-object v-for=\"(item, key) in config.toolbar.batchActions.others\" :config=\"item\" :key=\"key\" :selected=\"multipleSelection\" _v-01537689=\"\">\n              <el-button :disabled=\"this.$data.multipleSelection.length == 0\" v-if=\"item.enable\" type=\"info\" @click=\"eventHandler(item.handler, null, multipleSelection)\" plain=\"\" _v-01537689=\"\">\n                {{item.name}}\n              </el-button>\n            </action-object>\n          </template>\n        </template>\n\n        <!-- 下面这个el-col用于flex布局，勿删 -->\n        <el-col _v-01537689=\"\">\n        </el-col>\n        <!-- 新建等 常规按钮 -->\n        <template v-if=\"toolsVisible\">\n          <action-object v-if=\"config.toolbar.tools.new\" :config=\"config.toolbar.tools.new\" _v-01537689=\"\">\n            <el-button v-if=\"config.toolbar.tools.new.enable\" type=\"success\" icon=\"el-icon-document\" @click=\"eventHandler(config.toolbar.tools.new.handler)\" plain=\"\" _v-01537689=\"\">\n              {{config.toolbar.tools.new.name}}\n            </el-button>\n          </action-object>\n          <template v-if=\"config.toolbar.tools.others\">\n            <action-object v-for=\"(item, key) in config.toolbar.tools.others\" :key=\"key\" :config=\"item\" _v-01537689=\"\">\n              <el-button v-if=\"item.enable\" type=\"info\" @click=\"eventHandler(item.handler)\" plain=\"\" _v-01537689=\"\">\n                {{item.name}}\n              </el-button>\n            </action-object>\n          </template>\n        </template>\n      </el-row>\n    </el-col>\n  </el-row>\n\n  <el-row _v-01537689=\"\">\n    <el-col :span=\"24\" _v-01537689=\"\">\n      <el-table ref=\"multipleTable\" :data=\"tableData\" tooltip-effect=\"dark\" style=\"width: 100%\" @selection-change=\"handleSelectionChange\" _v-01537689=\"\">\n        <!-- 全选 -->\n        <el-table-column v-if=\"config.list.selectAll\" type=\"selection\" _v-01537689=\"\">\n        </el-table-column>\n        <!-- 其他表头 -->\n        <el-table-column v-for=\"(item, key) in config.list.columns\" :key=\"key\" :label=\"item.header\" _v-01537689=\"\">\n          <template slot-scope=\"scope\">\n            <template v-if=\"!item.component\">\n              {{ scope.row[item.dataField] }}\n            </template>\n            <template v-else=\"\">\n              <component v-bind:is=\"item.component.name.replace(/\\./g, '_')\" :config=\"item.component.config\" :value=\"item.component.value\" _v-01537689=\"\"></component>\n            </template>\n          </template>\n        </el-table-column>\n        <!-- 操作 -->\n        <el-table-column align=\"center\" label=\"操作\" _v-01537689=\"\">\n          <template slot-scope=\"scope\">\n            <template v-if=\"config.list.actions.others\">\n              <action-object v-for=\"item in config.list.actions.others\" :config=\"item\" :item=\"scope.row\" _v-01537689=\"\">\n                <el-button v-if=\"item.enable\" size=\"mini\" @click=\"eventHandler(item.handler, scope.row)\" _v-01537689=\"\">{{item.name}}</el-button>\n              </action-object>\n            </template>\n            <action-object v-if=\"config.list.actions.view\" :config=\"config.list.actions.view\" :item=\"scope.row\" _v-01537689=\"\">\n              <el-button v-if=\"config.list.actions.view.enable\" type=\"success\" size=\"mini\" @click=\"eventHandler(config.list.actions.view.handler, scope.row)\" _v-01537689=\"\">{{config.list.actions.view.name || '查看'}}</el-button>\n            </action-object>\n            <action-object v-if=\"config.list.actions.edit\" :config=\"config.list.actions.edit\" :item=\"scope.row\" _v-01537689=\"\">\n              <el-button v-if=\"config.list.actions.edit.enable\" type=\"primary\" size=\"mini\" @click=\"eventHandler(config.list.actions.edit.handler, scope.row)\" _v-01537689=\"\">{{config.list.actions.edit.name || '编辑'}}</el-button>\n            </action-object>\n            <action-object v-if=\"config.list.actions.delete\" :config=\"config.list.actions.delete\" :item=\"scope.row\" _v-01537689=\"\">\n              <el-button v-if=\"config.list.actions.delete.enable\" type=\"danger\" size=\"mini\" @click=\"eventHandlerConfirm(config.list.actions.delete.handler, scope.row, null, '删除该条数据？')\" _v-01537689=\"\">{{config.list.actions.delete.name || '删除'}}</el-button>\n            </action-object>\n          </template>\n        </el-table-column>\n      </el-table>\n    </el-col>\n  </el-row>\n\n  <el-row v-if=\"pagingVisible\" _v-01537689=\"\">\n    <!-- 页码 -->\n    <el-col align=\"right\" style=\"margin-top:30px;\" _v-01537689=\"\">\n      <el-pagination background=\"\" @size-change=\"handleSizeChange\" @current-change=\"currentChange\" layout=\"sizes, prev, pager, next\" :page-count=\"pageCount\" :current-page=\"value.pageNum \" :page-sizes=\"[20, 40, 60, 80, 100]\" _v-01537689=\"\">\n      </el-pagination>\n    </el-col>\n  </el-row>\n\n  <modal :visible.sync=\"modal.visible\" :modal-config=\"modal.modalConfig\" _v-01537689=\"\">\n    <component slot-scope=\"modalProps\" class=\"modalComponent\" :is=\"modal.name.replace(/\\./g, '_')\" :config=\"modal.config\" :value=\"modal.value\" :modalid=\"modalProps.modalId\" _v-01537689=\"\">\n    </component>\n  </modal>\n</div>";
